...
import { getGoals, getGoalById, updateGoal, deleteGoal, addGoal, getWeeklyGoalsData, getWeeklyData, getMonthlyData } from '../controllers/goalControllers.js';
...
router.get('/weekly-data/:id', getMonthlyData);
