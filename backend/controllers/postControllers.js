...
const getUserPosts = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const userPosts = await Post.find({ userId }).populate('userId', 'name email'); // Populate user details
...
const deletePost = asyncHandler(async (req, res) => {
    ...
    try {
        const postId = req.params.postId;
        const deletedPost = await Post.findOneAndDelete({ _id: postId, userId: req.userId });
